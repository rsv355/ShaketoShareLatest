 ...
 * it happens.
 *
 * <p>The API is designed to follow closely an {@link android.app.Activity} or a {@link android.app.Fragment} lifecycle.
 *
 * <h3>Usage</h3>
 *
 * <p>Below is an example usage within an {@link android.app.Activity}:
 *
 * <pre>
 ...
 * This is done by calling the {@link ShakeDetector#create(android.content.Context, OnShakeListener)} method.
 * Do not assume that the detector is created and started as this point. You should instead test the
 * returned value.
 *
 * <p>Second, we need to stop the listener when the {@link android.app.Activity} goes to the background. This is
 ...
 *
 * <p>Finally, we need to destroy the listener once the {@link android.app.Activity} gets destroyed. This is done
